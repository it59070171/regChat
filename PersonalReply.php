...
<body>
    ...
    <div class="container">
            <div class="ui centered card" style="width: 60%;">
                    <div class="content">
                        <div class="header" style="font-family: FCActiveRegular;font-size:25px;">ประกาศไปยัง คุณ <span style="color:orangered;">สมหมาย</span></div>
                    </div>
                    <div class="content">
                        <form class="ui form">
                            <div class="field">
                            <input type="file" name="myFile">
                                ...
                                <textarea placeholder="กรุณากรอกข้อความ.."></textarea>
                            </div>
                            <span  style="font-family: FCActiveRegular;font-size:15px;"><a href="personalAns.php" style="text-decoration:none"><i class="chevron left icon"></i>ย้อนกลับ</a></span>
