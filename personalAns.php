...
<body>
    ...
    <div class="container">
        <h1 style="font-family: FCActiveRegular; text-align: center;">ประกาศข่าวสารรายบุคคล</h1>
        <hr class="my-4">

        <div class="ui centered card">
            <div class="content">
                <div class="header" style="font-family: FCActiveRegular;font-size: 20px;text-align: center;">
                    รายชื่อบุคคลที่ใช้งานแชทบอท</div>
            </div>

        </div>
        <div class="ui centered card">
            <div class="content">
                <h3 style="font-family: FCActiveRegular;font-size:20px;"><img class="ui avatar image"
                        src="https://themindsetproject.com.au/wp-content/uploads/2017/08/avatar-icon-300x300.png">
                        สมหมาย
                        <div class="right floated author">
                            <a href="PersonalReply.php"><button class="ui icon button">
            ...
            <div class="content">
                    <h3 style="font-family: FCActiveRegular;font-size:20px;"><img class="ui avatar image"
                        ...
                        สมทรง
                        <div class="right floated author">
                            <a href="#"><button class="ui icon button">
                                    <i class="reply icon"></i>
                                  </button></a>
                              </div>
                </h3>
