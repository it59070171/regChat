...
<body>
    ...
    <div class="container">
            <div class="ui centered card" style="width: 60%;">
                    <div class="content">
                        <div class="header" style="font-family: FCActiveRegular;font-size:25px;">ตอบกลับคุณ <span style="color:orangered;">สมหมาย</span></div>
                        <p style="color:gray;font-size: 20px;">"พรุ่งนี้มีประชุมอาเซียน สถาบันปิดเรียนไหมคะ"</p>
                    </div>
                    <div class="content">
                        <form class="ui form">
                            <div class="field">
                            ...
                            <span  style="font-family: FCActiveRegular;font-size:15px;"><a href="CheckQuestion.php" style="text-decoration:none"><i class="chevron left icon"></i>ย้อนกลับ</a></span>
                            <button class="ui right floated button"
                                style="font-family: FCActiveRegular;font-size:15px;">ยืนยัน</button>
