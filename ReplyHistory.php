...
<body>
    ...
    <div class="container">
        <h1 style="font-family: FCActiveRegular; text-align: center;">ประวัติการตอบกลับ</h1>
        <hr class="my-4"><br>
        ...
        <a class="ui button" href="HistoryByUser.php" style="font-family: FCActiveRegular;">
                เลือกตอบรายบุคคล
                </a>
        <br><br>
        ...
        <div class="ui cards">
            <div class="card">
                <div class="content">
                    <div class="header" style="font-family: FCActiveRegular;">ชาติชาย</div>
                    <div class="meta">
                        <span>1 ก.ย.62</span>
                        <a>03:05 น.</a>
                    </div>
                    <div class="description" style="font-size: 15px;">
                        ประชุมอาเซียนมหาลัยหยุดไหมครับ
                    </div>
                </div>

               <div class="content">
                    <span style="color:#239B56;">ปิดเรียนวันที่ 23-24 ตุลาคม จากนั้นเปิดเรียนตามปกติค่ะ</span>
                    </div>
                    </div>

                    <div class="card">
                <div class="content">
                    <div class="header" style="font-family: FCActiveRegular;">กานดา</div>
                    <div class="meta">
                        <span>9 ก.ย.62</span>
                        <a>03:05 น.</a>
                    </div>
                    <div class="description" style="font-size: 15px;">
                       รับปริญญามหาลัยปิดไหมคะ
                    </div>
                </div>

               <div class="content">
                    <span style="color:#239B56;">ปิดเรียนวันที่ 11-12 พฤศจิกายน จากนั้นเปิดเรียนตามปกติค่ะ</span>
                    </div>
                    </div>
                    <div class="card">
                <div class="content">
                    <div class="header" style="font-family: FCActiveRegular;">จรุงใจ</div>
                    <div class="meta">
                        <span>1 พ.ย. 62</span>
                        <a>03:05 น.</a>
                    </div>
                    <div class="description" style="font-size: 15px;">
                       หยุดเรียนไหมคะรับปริญญา
                    </div>
                </div>
