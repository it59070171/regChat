...
<body>
    ...
    <div class="container">
            <div class="ui centered card" style="width: 60%;">
                    <div class="content">
                        <div class="header" style="font-family: FCActiveRegular;font-size:25px;">ตอบกลับคุณ <span style="color:orangered;">สมจิตร</span></div>
                        <p style="color:gray;font-size: 20px;">"จีบพนักงานได้มั้ยคัฟ"</p>
                    </div>
                    <div class="content">
                        <form class="ui form">
                            <div class="field">
                            ...
                            <span  style="font-family: FCActiveRegular;font-size:15px;"><a href="trashQ.php" style="text-decoration:none"><i class="chevron left icon"></i>ย้อนกลับ</a></span>
