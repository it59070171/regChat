...
<body>
    ...
    <div class="container">
        <h1 style="font-family: FCActiveRegular; text-align: center;">ส่งข้อความ</h1>
        <hr class="my-4">
  ...
  <div class="ui link cards">
                <a class="card" href="personalAns.php" style="text-decoration:none">
                    <div class="image">
                        <img src="https://i.imgur.com/oqezemP.jpg">
                    </div>
                    <div class="content">
                        <div class="center aligned header" style="font-family: FCActiveRegular;">ส่งข้อความรายบุคคล</div>
                    </div>
    </a>
                <a class="card" href="AddMsg.php" style="text-decoration:none">
                    <div class="image">
                        <img src="https://i.imgur.com/qufPVfO.jpg">
                    </div>
                    <div class="content">
                        <div class="center aligned header" style="font-family: FCActiveRegular;">ส่งข้อความประกาศ</div>
